    ...
    <div
      className={cn(
        "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
        {
          ...
          "border-transparent bg-orange-500 text-white shadow hover:bg-orange-600": variant === "warning",
          "border-transparent bg-yellow-400 text-yellow-950 shadow hover:bg-yellow-500": variant === "gold",
        },
        className
      )}
      {...props}
